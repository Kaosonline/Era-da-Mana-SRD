...
- Jogadas de ataque à distância, incluindo muitos ataques de magia à distância, como luz escaldante.
...
- Número de idiomas adicionais que seu personagem conhece no início do jogo. Se você tiver uma penalidade, ainda poderá ler e falar seus idiomas nativos, a menos que sua Inteligência seja menor que 3.

- Número de pontos de perícia ganhos a cada nível, embora seu personagem sempre receba pelo menos 1 ponto de perícia por nível.
...
- Testes de Blefar, Diplomacia, Disfarce, Lidar com Animais, Intimidação, Atuação e Usar Objetos Mágicos.
