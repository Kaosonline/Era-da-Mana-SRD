...
**Eschool** Transmutation [poison]; **Level** Arcane 4, Divine 4

**CONJURATION**
**Casting Time** 1 standard action  **Components** V, S, M/DF (a hair from a spider)

**EFFECT**
**Range** close (25 ft. + 5 ft./2 levels)  **Targets** one Medium or smaller item  **Duration** 1 round/level (D)  **Saving Throw** Will negates (object)  **Spell Resistance** yes (object)
